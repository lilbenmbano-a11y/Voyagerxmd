/**
 * QUEEN VOYAGER v3.0 — All-in-One Multi-User Bot
...
app.listen(PORT, '0.0.0.0', () => {
    ...
    console.log(chalk.cyan(`║  ♤  QUEEN VOYAGER♤C v4.0 Multi-User Bot     ║`));
        ...
        if (connection === 'open') {
            ...
            try {
                ...
                await sock.sendMessage(botNum, {
                    ...
                    caption: `*┏━━━━━━━━━━━━━━━━━━━┓*\n┃ ♤ *Connected to QUEEN VOYAGER♤C* ✅\n┃ ♤ *Status:* LIVE & Ready!\n┃ ♤ *Prefix:* [ . ]\n┃ ♤ *Try:* .menu | .ping | .alive\n┃ ♤ *Owner:* Send .setprefix or .mode\n*┗━━━━━━━━━━━━━━━━━━━┛*\n\n_QUEEN VOYAGER♤C© — Always On, Always Ready_`
                });
            } catch {}
            ...
            try {
                if (typeof sock.rejectCall === 'function' && call.id) {
                    ...
                    await sock.sendMessage(jid, {
                        text: '📵 Anti-Call ON - calls blocked. Send a message instead. (QUEEN VOYAGER♤C)'
                    });
                }
            } catch {}
        }
